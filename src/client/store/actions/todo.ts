...
export const todo_update = text => {
  return dispatch => {
    ...
    return new Promise<void>((resolve, reject) => {
      axios.post2('/todo/update', text).then(res => {
